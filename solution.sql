...
-- 3. The bank is giving a new customer bonus! Update all records with an account balance of 0.00 and a
-- transactions_attempted of 0. Give them a new account balance of 10.00.
...
VALUES ('zombie', 'london', '1', '153', '12.48');

-- 9. The bank is losing money in Miami and Phoenix and needs to unload low transaction customers: Delete users that
-- reside in miami OR phoenix and have completed fewer than 5 transactions.
DELETE FROM syntax_practice
WHERE city = 'phoenix' AND transactions_completed < 5 OR city = 'miami' AND transactions_completed < 5;